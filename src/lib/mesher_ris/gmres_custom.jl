...
function gmres_custom(b, restarted, tol, maxit, x, wk, incidence_selection, P_data, Lp_data, Z_self, Yle, invZ, invP, F, resProd)
    # @profile begin
    ...
    n2b = norm(b);                   
    if (n2b == 0)                    
        x::Union{Vector{ComplexF64}, Vector{Float64}} = zeros(n,1);              
        flag::Int64 = 0;                    
        relres::Float64 = 0;                  
    ...
    r = b - ComputeMatrixVector(x, wk, incidence_selection, P_data, Lp_data, Z_self, Yle, invZ, invP, F, resProd)
    ...
    for outiter = 1:outer 
        ...
        for initer = 1:inner
            ...
            # Apply A to v.
            v = ComputeMatrixVector(x, wk, incidence_selection, P_data, Lp_data, Z_self, Yle, invZ, invP, F, resProd)
